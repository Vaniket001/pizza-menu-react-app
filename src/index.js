  ...
  return (
    <footer className="footer">
      <div className="order">
        {/* {isOpen && (
          <p>
            {currentTime}, We're currently open, Come visit us or order online.
          </p>
        )}
        {!isOpen && <p>Sorry, We're currently Closed!</p>} */}
        {isOpen ? (
...
function Order(props) {
  return (
    <p>
      {props.currentTime}, We're currently open, Come visit us or order online.
    </p>
  );
}
